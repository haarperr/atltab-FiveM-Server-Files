...
function OpenAnimationsMenu()
	...
	table.insert(elements, {label = 'Sync animation', value = 'sync'})
	table.insert(elements, {label = 'favorite [Y]', value = 'favorite'})
...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustReleased(0, Keys['Y']) and not isDead and not IsPedInAnyVehicle(GetPlayerPed(-1)) then
