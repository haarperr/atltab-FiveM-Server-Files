...
AddEventHandler("gcPhone:acceptCall", function(infoCall, initiator)
  if inCall == false and USE_RTC == false then
    inCall = true
    -- NetworkSetVoiceChannel(infoCall.id + 1) -- replaced with toko
    -- NetworkSetTalkerProximity(0.0) -- replaced with toko
...
AddEventHandler("gcPhone:rejectCall", function(infoCall)
  if inCall == true then
    ...
    -- NetworkSetTalkerProximity(2.5) -- replaced with toko
