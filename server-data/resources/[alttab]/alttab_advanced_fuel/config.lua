...
Config.Strings = {
	...
	EToRefuel = "Appuyez sur ~g~E~w~ pour faire le plein de véhicule",
	JerryCanEmpty = "Le Jerrycan est vide",
	FullTank = "Réservoir est plein",
	PurchaseJerryCan = "Appuyez sur ~g~E ~w~pour acheter un Jerrycan ~g~" .. Config.JerryCanCost .. " dh",
	...
	JerryCanFull = "Jerrycan est plein",
	TotalCost = "Prix",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Appuyez sur ~g~E ~w~poure prendre le Jerrycan"
