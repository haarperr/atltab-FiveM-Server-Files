Locales['fr'] = {
  ...
  ['invite'] = 'inviter',
  ['dirty_money'] = 'argent sale: <span style="color: red;">%s DH</span>',
  ['inventory'] = 'inventaire',
  ['amount'] = 'quantité ?',
  ['amount_invalid'] = 'montant invalide',
  ['press_to_exit'] = 'appuyez sur ~INPUT_CONTEXT~ pour sortir de la propriété',
  ['rented_for'] = 'vous avez loué une propriété pour ~g~%s DH~s~',
  ['purchased_for'] = 'vous avez acheté une propriété pour ~g~%s DH~s~',
  ['made_property'] = 'vous avez rendu une propriété',
  ['not_enough'] = 'vous n\'avez pas assez d\'argent',
  ['invalid_quantity'] = 'quantité invalide',
  ['paid_rent'] = 'vous avez ~g~payé~s~ votre loyer: ~g~%s DH~s~',
