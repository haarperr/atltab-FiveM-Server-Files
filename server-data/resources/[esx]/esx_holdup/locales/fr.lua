Locales['fr'] = {
  ...
  ['robbery_timer'] = 'braquage en cours: ~r~%s~s~',
  ['recently_robbed'] = 'ce magasin a déjà été braqué. Attendez ~r~%s~b~',
  ...
  ['robbery_complete'] = '~w~Braquage terminé~s~. Vous avez ~r~volé~s~ ~g~$%s~s~',
  ...
  ['no_threat'] = 'vous n\'avez pas d\'arme en main pour faire peur aux autres',
}
