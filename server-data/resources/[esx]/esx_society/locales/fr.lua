Locales['fr'] = {
  ...
  ['fire']                   = 'licencier',
  ['grade']                  = 'grade',
  ['have_deposited']         = 'vous avez déposé ~r~%s DH~s~',
  ['have_withdrawn']         = 'vous avez retiré ~g~%s DH~s~',
  ...
  ['yes']                    = 'oui',
  ['you_have']               = 'vous avez ~g~%s DH~s~ en attente de ~r~blanchiement~s~ (24h).',
  ['you_have_laundered']     = 'vous avez ~r~blanchi~s~ votre argent : ~g~%s DH~s~',
