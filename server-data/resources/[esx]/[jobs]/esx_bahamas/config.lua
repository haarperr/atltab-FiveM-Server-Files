...
Config.AuthorizedVehicles = {
    { name = 'coach',  label = 'Bahamamas Bus' },
	{ name = 'pbus2',  label = 'Bus events' },
...
Config.Zones = {
    ...
    Vaults = {
        Pos   = { x = -1391.504, y = -601.017, z = 29.500 },
    ...
    Vehicles = {
        Pos          = { x = -1357.171, y = -596.753, z = 29.239 },
    ...
    Helicopters = {
        Pos          = { x = -1378.586, y = -605.287, z = 43.250 },
    ...
    BossActions = {
        Pos   = { x = -1390.158, y = -600.440, z = 30.500 },
        Size  = { x = 1.0, y = 1.0, z = 1.0 },
        Color = { r = 0, g = 100, b = 0 },
        Type  = 22,
    },
...
----- TELEPORTERS -----
 ...
 Config.TeleportZones = {
  EnterBuilding = {
    Pos       = { x = -1389.141, y = -592.074, z = 29.319 },
    Size      = { x = 1.2, y = 1.2, z = 0.1 },
    Color     = { r = 128, g = 128, b = 128 },
    Marker    = 1,
    Hint      = _U('e_to_enter_1'),
    Teleport  = { x = -1385.264, y = -606.384, z = 29.319 }
  },

  ExitBuilding = {
    Pos       = { x = -1385.264, y = -606.384, z = 29.319 },
    Size      = { x = 1.2, y = 1.2, z = 0.1 },
    Color     = { r = 128, g = 128, b = 128 },
    Marker    = 1,
    Hint      = _U('e_to_exit_1'),
    Teleport  = { x = -1389.141, y = -592.074, z = 29.319 },
  },
  
  EnterBuilding2 = {
    Pos       = { x = -1386.306, y = -627.525, z = 29.819 },
    Size      = { x = 1.2, y = 1.2, z = 0.1 },
    Color     = { r = 128, g = 128, b = 128 },
    Marker    = 1,
    Hint      = _U('e_to_enter_1'),
    Teleport  = { x = -1371.362, y = -625.990, z = 29.819 }
  },

  ExitBuilding2 = {
    Pos       = { x = -1371.362, y = -625.990, z = 29.819 },
    Size      = { x = 1.2, y = 1.2, z = 0.1 },
    Color     = { r = 128, g = 128, b = 128 },
    Marker    = 1,
    Hint      = _U('e_to_exit_1'),
    Teleport  = { x = -1386.306, y = -627.525, z = 29.819 },
  },

  EnterHeliport = {
    Pos       = { x = -1350.425, y = -634.940, z = 27.700 },
    Size      = { x = 1.8, y = 1.8, z = 1.0 },
    Color     = { r = 204, g = 204, b = 0 },
    Marker    = 22,
    Hint      = _U('e_to_enter_2'),
    Teleport  = { x = -1381.821, y = -600.315, z = 42.500 }
  },

  ExitHeliport = {
    Pos       = { x = -1381.821, y = -600.315, z = 42.200 },
    Size      = { x = 2.0, y = 2.0, z = 0.2 },
    Color     = { r = 204, g = 204, b = 0 },
    Marker    = 1,
    Hint      = _U('e_to_exit_2'),
    Teleport  = { x = -1350.425, y = -634.940, z = 26.900 },
  },
