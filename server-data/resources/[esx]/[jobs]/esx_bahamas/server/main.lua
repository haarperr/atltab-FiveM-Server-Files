...
RegisterServerEvent('esx_bahamas:getStockItem')
AddEventHandler('esx_bahamas:getStockItem', function(itemName, count)
...
ESX.RegisterServerCallback('esx_bahamas:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_bahamas:putStockItems')
AddEventHandler('esx_bahamas:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_bahamas:getFridgeStockItem')
AddEventHandler('esx_bahamas:getFridgeStockItem', function(itemName, count)
...
ESX.RegisterServerCallback('esx_bahamas:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_bahamas:putFridgeStockItems')
AddEventHandler('esx_bahamas:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_bahamas:buyItem')
AddEventHandler('esx_bahamas:buyItem', function(itemName, price, itemLabel)
...
RegisterServerEvent('esx_bahamas:craftingCoktails')
AddEventHandler('esx_bahamas:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_bahamas:getVaultWeapons', function(source, cb)
...
ESX.RegisterServerCallback('esx_bahamas:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_bahamas:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_bahamas:getPlayerInventory', function(source, cb)
