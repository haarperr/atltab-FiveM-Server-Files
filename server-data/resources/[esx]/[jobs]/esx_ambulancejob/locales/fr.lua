Locales['fr'] = {
  ...
  -- Death
  ['respawn_available_in'] = 'réanimation possible dans ~b~%s:%s~s~',
  ['respawn_bleedout_in'] = 'réanimation automatique dans ~b~%s:%s~s~\n',
  ['respawn_bleedout_prompt'] = 'maintenez ~g~E~s~ pour être réanimé',
  ...
  ['combatlog_message'] = '~r~ne quittez pas la ville si vous êtes mort/en coma.',
  -- Revive
