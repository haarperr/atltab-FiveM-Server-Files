Locales['fr'] = {
  ...
  ['buy_vehicle_shop']                = 'acheter %s pour %s DH?',
  ['buy_vehicle']                     = 'acheter véhicule',
  ['car_dealer']                      = 'Véhicule de service',
  ...
  ['not_yours']                       = 'ce véhicule ne vous appartient pas ou n\'est pas de service',
  ['paid_rental']                     = 'vous avez ~g~payé~s~ votre location de véhicule: ~g~%s DH~s~',
  ...
  ['sell_menu']                       = 'appuyez sur ~INPUT_CONTEXT~ pour vendre ~y~%s~s~ au prix de ~g~%s DH~s~',
  ...
  ['vehicle_sold_for']                = 'le ~b~%s~s~ a été ~y~vendu~s~ pour ~g~%s DH~s~',
