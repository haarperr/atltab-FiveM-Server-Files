...
if PlayerData.job.name  == 'realestateagent' and PlayerData.job.grade_name == 'boss' then  
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'realestateagent', vehicleProps)
...
AddEventHandler('esx:playerLoaded', function(xPlayer)
  ...
  if PlayerData.job.name == 'realestateagent' then
    Config.Zones.OfficeActions.Type = 22
  else
...
AddEventHandler('esx:playerLoaded', function(xPlayer)
  ...
  if PlayerData.job.name  == 'realestateagent' and PlayerData.job.grade_name == 'boss' then
    Config.Zones.Vehicles.Type = 22
  else
    Config.Zones.Vehicles.Type = -1
  end
...
AddEventHandler('esx_realestateagentjob:hasEnteredMarker', function(zone)
  ...
  if zone == 'OfficeActions' and PlayerData.job ~= nil and PlayerData.job.name == 'realestateagent' then
    CurrentAction     = 'realestateagent_menu'
    CurrentActionMsg  = ('press_to_access')
    CurrentActionData = {}
  end

  if zone == 'Vehicles' and PlayerData.job ~= nil and PlayerData.job.name == 'realestateagent' and PlayerData.job.grade_name == 'boss' then
    CurrentAction     = 'menu_vehicle_spawner'
    CurrentActionMsg  = _U('vehicle_spawner')
    CurrentActionData = {}
  end

  if zone == 'VehicleDeleter' and PlayerData.job ~= nil and PlayerData.job.name == 'realestateagent' and PlayerData.job.grade_name == 'boss'  then
