...
Config.NPCJobEarnings             = { min = 75, max = 200 }
...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -206.77, y = -1341.65, z = 34.89 },
	...
	Craft = {
		Pos   = { x = -198.19, y = -1315.21, z = 31.10 },
		Size  = { x = 1.0, y = 1.0, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 2
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -187.88, y = -1289.66, z = 31.696 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = -188.85, y = -1284.03, z = 30.3 },
