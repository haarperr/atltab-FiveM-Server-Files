...
TriggerEvent('esx:getSharedObject', function(obj) ESX = obj end)
local foodPeds = {
  { model="s_f_y_stripperlite", x=112.68, y=-1288.3, z=28.46, a=238.85, animation="mini@strip_club@private_dance@idle", animationName="priv_dance_idle"},
  { model="s_f_y_stripper_02", x=-1383.3, y=-612.07, z=31.76, a=132.61, animation="mini@strip_club@private_dance@idle", animationName="priv_dance_idle"},
  ...
  { model="s_f_y_stripperlite", x=-1379.95, y=-617.22, z=32.76, a=130.8, animation="mini@strip_club@lap_dance@ld_girl_a_song_a_p1", animationName="ld_girl_a_song_a_p1_f"},
...
Citizen.CreateThread(function()
    ...
    local coords = GetEntityCoords(PlayerPedId())
        if GetDistanceBetweenCoords(coords, 117.19, -1294.86, 28.42, true) < 100 then
            ...
            Draw3DText(117.19, -1294.86, 29.63, tostring("Appuyez sur ~ r ~ [E] ~ w ~ pour acheter un tour de danse [1500 DHS]"))
...
AddEventHandler('esx_lapdance:lapdance', function(chaiseParam)
      chaise = chaiseParam
      RequestModel(-1661836925)
      while not HasModelLoaded(-1661836925) do
        Wait(0)
      end
      TriggerEvent("malte-cinema:activate")
      SetEntityHeading(PlayerPedId(), 120.18)
      local SpawnObject = CreatePed(4, -1661836925, chaise.spawnObject[1], chaise.spawnObject[2], chaise.spawnObject[3])
      ...
      isInLapdance = true
      SetEntityCoords(PlayerPedId(), 116.88, -1295.04, 28.42)
      SetEntityHeading(SpawnObject, 303.19)
      FreezeEntityPosition(SpawnObject, true)
      TaskGoToCoordAnyMeans(PlayerPedId(), chaise.premierPassage[1], chaise.premierPassage[2], chaise.premierPassage[3], 1.0, 0, 0, 786603, 1.0)
      Citizen.Wait(5000)
      FreezeEntityPosition(SpawnObject, false)
      TaskGoToCoordAnyMeans(SpawnObject, chaise.deuxiemePassage[1], chaise.deuxiemePassage[2], chaise.deuxiemePassage[3], 174.93, 0, 0, 0, 0xbf800000)
      Citizen.Wait(2050)
      TaskGoToCoordAnyMeans(SpawnObject, chaise.troisiemePassage[1], chaise.troisiemePassage[2], chaise.troisiemePassage[3], 174.93, 0, 0, 0, 0xbf800000)
      Citizen.Wait(1750)
      FreezeEntityPosition(SpawnObject, true)
      ...
      Citizen.Wait(5000)
      FreezeEntityPosition(SpawnObject, false)
      TaskGoToCoordAnyMeans(SpawnObject, chaise.passageDeFin[1], chaise.passageDeFin[2], chaise.passageDeFin[3], 174.93, 0, 0, 0, 0xbf800000)
      Citizen.Wait(2000)
      RequestAnimDict("mini@strip_club@idles@stripper")
        while not HasAnimDictLoaded("mini@strip_club@idles@stripper") do
          Citizen.Wait(100)
      ...
      TriggerServerEvent('esx_lapdance:ChangeState',chaise)
...
Citizen.CreateThread(function()
  ...
  Citizen.Wait(0)
    ...
    local coords = GetEntityCoords(PlayerPedId())
    if GetDistanceBetweenCoords(coords, chaise.posSitDown[1], chaise.posSitDown[2], chaise.posSitDown[3], true) < 1.5 and isInLapdance then
      ...
      SetEntityCoords(PlayerPedId(), chaise.posSitUp[1], chaise.posSitUp[2], chaise.posSitUp[3])
      FreezeEntityPosition(PlayerPedId(), true)
      SetEntityHeading(PlayerPedId(), 39.0)
      TaskPlayAnim(PlayerPedId(), dict, "ld_2g_sit_idle", 8.0, -8.0, -1, 0, 0, false, false, false)
      repeat
      TaskPlayAnim(PlayerPedId(), dict, "ld_2g_sit_idle", 8.0, -8.0, -1, 0, 0, false, false, false)
      Citizen.Wait(550)
      until(isInLapdance == false)
      FreezeEntityPosition(PlayerPedId(), false)
      SetEntityCoords(PlayerPedId(), chaise.posSitDown[1], chaise.posSitDown[2], chaise.posSitDown[3])
      Citizen.Wait(200)
      TaskGoToCoordAnyMeans(PlayerPedId(), 117.48, -1294.82, 28.43, 1.0, 0, 0, 786603, 1.0)
      Citizen.Wait(5800)
      TriggerEvent("malte-cinema:activate")
      else
    -- nothing
