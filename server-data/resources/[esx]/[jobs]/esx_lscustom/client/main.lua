...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(0)
		-- Display markers
		if (PlayerData.job and PlayerData.job.name == 'mechanic') and (PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'chief' or PlayerData.job.grade_name == 'experimente') then
		...
		if IsPedInAnyVehicle(playerPed, false) then
			...
			if IsControlJustReleased(0, 38) and not lsMenuIsShowed and isInLSMarker then
				if (PlayerData.job and PlayerData.job.name == 'mechanic') and (PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'chief' or PlayerData.job.grade_name == 'experimente') or not Config.IsMechanicJobOnly then
