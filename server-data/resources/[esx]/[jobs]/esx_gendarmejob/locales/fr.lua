Locales['fr'] = {
  ...
  ['armory_bought'] = 'vous achetez un ~y~%s~s~ pour ~r~%s DH~s~',
  ...
  ['vehicleshop_bought'] = 'vous avez acheté ~y~%s~s~ pour ~r~%s DH~s~',
  ...
  ['being_searched'] = 'vous êtes ~y~recherché(e)~s~ par la ~b~Gendarme~s~',
  -- Vehicle interaction
  ...
  ['you_confiscated_account'] = 'vous avez confisqué ~g~%s DH~s~ (%s) à ~b~%s~s~',
  ['got_confiscated_account'] = '~g~%s DH~s~ (%s) ont été confisqués par ~y~%s~s~',
  ...
  ['police_stock'] = 'coffre de la gendarme',
  -- Misc
  ...
  -- Notifications
  ['alert_police'] = 'alerte gendarme',
  ['phone_police'] = 'gendarme',
}
