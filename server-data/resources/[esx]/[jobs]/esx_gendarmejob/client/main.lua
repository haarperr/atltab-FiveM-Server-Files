...
AddEventHandler('esx_phone:cancelMessage', function(dispatchNumber)
	if PlayerData.job and PlayerData.job.name == 'gendarme' and PlayerData.job.name == dispatchNumber then
...
AddEventHandler('esx_policejob:hasEnteredEntityZone', function(entity)
	...
	if PlayerData.job and PlayerData.job.name == 'gendarme' and IsPedOnFoot(playerPed) then
...
Citizen.CreateThread(function()
	while true do
		...
		if PlayerData.job and PlayerData.job.name == 'gendarme' then
...
Citizen.CreateThread(function()
	while true do
		...
		if CurrentAction then
			...
			if IsControlJustReleased(0, 38) and PlayerData.job and PlayerData.job.name == 'gendarme' then
				...
				elseif CurrentAction == 'menu_boss_actions' then
					local secured = "."
					ESX.UI.Menu.CloseAll()
					TriggerEvent('esx_society:openBossMenu', 'gendarme', function(data, menu)
						menu.close()
		...
		if IsControlJustReleased(0, 167) and not isDead and PlayerData.job and PlayerData.job.name == 'gendarme' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'police_actions') then
			if Config.MaxInService == -1 then
	...
	if PlayerData.job and PlayerData.job.name == 'gendarme' then
		ESX.TriggerServerCallback('esx_society:getOnlinePlayers', function(players)
			for i=1, #players, 1 do
				if players[i].job.name == 'gendarme' then
