Locales ['fr'] = {
  ...
  ['weed_processingenough'] = 'vous devez avoir ~b~1x~s~ ~g~Cannabis~s~ pour lancer une transformation.',
  ['weed_processed'] = 'vous avez transformé ~b~1x~s~ ~g~Cannabis~s~ en ~b~%sx~s~ ~g~Marijuana~s~',
  ...
  ['dealer_sold'] = 'vous avez vendu ~b~%sx~s~ ~y~%s~s~ pour ~g~%s DH~s~',
  ...
  ['license_no'] = 'non',
  ['license_bought'] = 'vous avez acheté ~b~%s~s~ pour ~r~%s DH~s~',
