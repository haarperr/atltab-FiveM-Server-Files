Locales['fr'] = {
  ...
  ['gave_money'] = 'vous avez donné ~g~%s DH~s~ à ~y~%s~s~',
  ['received_money'] = 'vous avez reçu ~g~%s DH~s~ par ~b~%s~s~',
  ['gave_account_money'] = 'vous avez donné ~g~%s DH~s~ (%s) à ~y~%s~s~',
  ['received_account_money'] = 'vous avez reçu ~g~%s DH~s~ (%s) par ~b~%s~s~',
  ...
  ['threw_money'] = 'vous avez jeté ~r~%s DH~s~ ~b~cash~s~',
  ['threw_account'] = 'vous avez jeté ~r~%s DH~s~ ~b~%s~s~',
  ['threw_weapon'] = 'vous avez jeté ~y~1x~s~ ~b~%s~s~',
  ['threw_weapon_ammo'] = 'vous avez jeté ~y~1x~s~ ~b~%s~s~ avec ~o~%sx~s~ balles',
  -- Salary related
  ['received_salary'] = 'salaire reçu ~h~~g~%s DH~s~',
  ['received_help'] = 'aide de l\'état reçu ~h~~g~%s DH~s~',
  ...
  ['money_set'] = 'quelqu\'un de ~y~haut placé~s~ vous a attribué ~g~%s DH~s~ (%s) !',
